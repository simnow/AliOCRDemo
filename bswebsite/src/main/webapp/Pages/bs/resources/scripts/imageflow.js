...
function ImageFlow() {
    ...
    this.defaults =
	{
        ...
        // onmouseenter: function () { document.location = this.url; },   /* Onclick behaviour */
	    opacity: false,          /* Toggle image opacity */
	    opacityArray: [10, 8, 6, 4, 2],   /* Image opacity (range: 0 to 10) first value is for the focussed image */
	    percentLandscape: 148,            /* Scale landscape format */
	    ...
	    sliderWidth: 4,             /* Width of the slider in px */
    ...
    this.refresh = function () {
        ...
        if (my.buttons) {
            ...
            // my.buttonPreviousDiv.onmouseenter = function () { my.MouseWheel.handle(1); };
            // my.buttonNextDiv.onclick = function () { my.MouseWheel.handle(-1); };
            // my.buttonNextDiv.onmouseenter = function () { my.MouseWheel.handle(-1); };
        }
                    ...
                    try
                    {
                        ...
                        switch (image.i == my.imageID)
                        {
                            case false:
                                ...
                                // image.onmouseenter = function () { my.glideTo(this.i); };
                                break;
                            ...
                            default:
                                ...
                                if (image.url !== '')
                                {
                                    ...
                                    // image.onmouseenter = my.onmouseenter;
                                }
                                break;
                        }
    ...
    this.Slideshow =
	{
	    ...
	    start: function () {
            ...
            // my.buttonSlideshow.onmouseenter = function () { my.Slideshow.stop(); };
	    ...
	    stop: function () {
            ...
            // my.buttonSlideshow.onmouseenter = function () { my.Slideshow.start(); };
