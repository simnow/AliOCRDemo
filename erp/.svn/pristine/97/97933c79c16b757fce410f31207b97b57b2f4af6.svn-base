...
public class TaskController {
	...
	*/ 
	...
	@ResponseBody
	public Message procedureGetTaskPageList(@RequestParam(value="pagesize",required=true) int pagesize,@RequestParam(value="pageno",required=true) int pageno){
		
		 Message message=new Message(); 
		
		 message.setObj(taskService.procedureGetTaskListByCondition(pagesize, pageno)); 
		 return message;
