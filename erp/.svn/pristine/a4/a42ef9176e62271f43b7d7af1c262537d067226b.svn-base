...
public class SessionStatisticsServiceImpl implements StatisticsService {
	...
	public List<OnlineDepartmentUserEntity> updateAndGetOnlineDepartmentUserList() {
		...
		Map<String, Map<String, LoginLog>> loginUserMap = this.updateAndGetLoginUsers();
		if (loginUserMap != null) {
			...
			redisService.set(Contants.REDIS_ONLINE_USER_COUNT, onlineUserCount);
		}
	...
	public int getSimilarOnlineUserCount() {
		// TODO Auto-generated method stub
		int onlineUserCount = 0;
		Object onlineUserCountObj = redisService.get(Contants.REDIS_ONLINE_USER_COUNT);
		if (onlineUserCountObj != null) {
			onlineUserCount = (int) onlineUserCountObj;
		}
